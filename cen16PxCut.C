...
int cen16PxCut()
{
    ...
    TH2D *hCenVsPxL = (TH2D*) fin -> Get("hCen16VsPxL");
    TH2D *hCenVsPxR = (TH2D*) fin -> Get("hCen16VsPxR");

    TCanvas *c2 = new TCanvas("c2","c2",0,0,1200,1200);
    ...
    hPxL[0]->SetTitle("centrality 75-80%");
    hPxL[1]->SetTitle("centrality 70-75%");
    hPxL[2]->SetTitle("centrality 65-70%");
    hPxL[3]->SetTitle("centrality 60-65%");
    hPxL[4]->SetTitle("centrality 55-60%");
    hPxL[5]->SetTitle("centrality 50-55%");
    hPxL[6]->SetTitle("centrality 45-50%");
    hPxL[7]->SetTitle("centrality 40-45%");
    hPxL[8]->SetTitle("centrality 35-40%");
    hPxL[9]->SetTitle("centrality 30-35%");
    hPxL[10]->SetTitle("centrality 25-30%");
    hPxL[11]->SetTitle("centrality 20-25%");
    hPxL[12]->SetTitle("centrality 15-20%");
    hPxL[13]->SetTitle("centrality 10-15%");
    hPxL[14]->SetTitle("centrality  5-10%");
    hPxL[15]->SetTitle("centrality  0- 5%");
